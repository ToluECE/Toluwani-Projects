...
REM
REM Generated by Vivado on Wed May 06 11:09:57 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj soc_top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj soc_top_tb_vlog.prj -log xvlog.log
